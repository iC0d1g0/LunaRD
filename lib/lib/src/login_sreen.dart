...
import 'package:luna_rd/components/mytext.dart';
        ...
        child: SafeArea(
          child: Column(
            ...
            children: [
              ...
              Image.asset("assets/images/lun.png",
              width: 300,
              ),
              
              const SizedBox(height: 10),
              const MyText(hintText:"correo o usuario",
              ),
